...
public class MessageFromMeSQLLiteOpenHelper extends SQLiteOpenHelper {
    ...
    private static MessageFromMeSQLLiteOpenHelper classInstance;


    public static MessageFromMeSQLLiteOpenHelper getInstance(Context context) {
        if (classInstance == null) {
            classInstance = new MessageFromMeSQLLiteOpenHelper(context);
        }
        return classInstance;
    }


    private MessageFromMeSQLLiteOpenHelper(Context context) {
